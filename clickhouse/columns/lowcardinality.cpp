...
void ColumnLowCardinality::SaveBody(OutputStream* output) {
    const uint64_t index_serialization_type = static_cast<uint32_t>(indexTypeFromIndexColumn(*index_column_))
        | static_cast<uint32_t>(IndexFlag::HasAdditionalKeysBit);
