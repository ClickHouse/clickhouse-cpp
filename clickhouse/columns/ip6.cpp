...
ColumnIPv6::ColumnIPv6() : Column(Type::CreateIPv6()), data_(std::make_shared<ColumnFixedString>(16)) {
}

ColumnIPv6::ColumnIPv6(ColumnRef data) : Column(Type::CreateIPv6()), data_(data->As<ColumnFixedString>()) {
    if (data_->Size() != 0) {
...
std::ostream& ColumnIPv6::Dump(std::ostream& o, size_t index) const {
